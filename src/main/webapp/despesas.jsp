...
<html lang="pt-br">
    ...
    <c:if test="${not empty err }">
        ...
        <div class="d-grid gap-4 col-3 mx-auto m-5">
            ...
            <table class="table">
                <tr>
                    <td colspan="2" class="table-active">Id</td>
                    <td colspan="2" class="table-active">Descrição</td>
                    <td colspan="2" class="table-active">Valor</td>
                </tr>
                <tr>
                    <td colspan="2" class="table-active">label</td>
                    <td colspan="2" class="table-active">label</td>
                    <td colspan="2" class="table-active">label</td>
                </tr>
                <tr>
        ...
        <div class="btn-space">
            <button class="">Adicionar despesas</button>
        </div>
