...
<head>
    ...
    <title>Future Planner: Investimentos</title>
...
<div class="d-grid gap-4 col-3 mx-auto">
    <h1 class="title">Cadastrar Investimento</h1>
    ...
    <div class="collapse multi-collapse" id="multiCollapseExample1">
        <div class="card card-body">
            <form class="row g-3 needs-validation was-validated" novalidate=""
                  action="investimento-servlet" method="post">

                <div class="d-grid gap-4 mb-3">
                    <input type="text" name="nome" class="form-control" placeholder="Nome do Investimento">
                ...
                <div class="d-grid gap-4 mb-3">
                    <input type="text" name="dataInicial" class="form-control" placeholder="Data Inicial">
                    <div class="invalid-feedback">
                        Data Inicial
                    </div>
                </div>
    ...
    <table class="table table-striped table-bordered table-gray">
        <tr>
            ...
            <th colspan="2" class="table-active">Valor</th>
             <th colspan="2" class="table-active">Data Inicial</th>
        </tr>
